...
--
-- Table structure for table `b_unit_scores`
--

CREATE TABLE `b_unit_scores` (
...
--
-- Indexes for table `b_unit_scores`
--
ALTER TABLE `b_unit_scores`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `e_group_scores_gst_app_id_unique` (`gst_app_id`),
...
--
-- AUTO_INCREMENT for table `b_unit_scores`
--
ALTER TABLE `b_unit_scores`
