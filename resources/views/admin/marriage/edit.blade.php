    ...
    <div class="page-content">
                ...
                <div class="card border-top border-0 border-4 border-info">
                    <div class="card-body">
                        ...
                        <div class="border p-4 rounded">
                               <form action="{{ route('admin.marriage.update', $marriage->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
      ...
      <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " name="husband_name" class="form-control" placeholder="Please Enter Full Name of the Husband"  value="{{ $marriage->husband_name }}" >
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="text" style="max-width:200px; height: 35px; " name="husband_religion" class="form-control"  placeholder="Religion" value="{{ $marriage->husband_religion }}" >
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="date" style="max-width:200px; height: 35px; " name="husband_birthday" class="form-control" id="inputEmail" placeholder="date" value="{{ $marriage->husband_birthday }}">
        ...
        <div class="row mt-4">
          <div class="col-md-6">
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input type="number" class="form-control col-sm-9" id="exampleInput4" name="husband_nid" placeholder=" Nid No" value="{{$marriage->husband_nid}}"  />
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="exampleInput4" name="husband_city_name" placeholder="City Name" value="{{$marriage->husband_city_name}}" />
        ...
        <div class="row">
           ...
           <div class="col-md-6">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="exampleInput4" name="husband_road_name" placeholder="Road / Street Name" value="{{$marriage->husband_road_name}}" />
          ...
          <div class="col-md-6">
            <div class=" row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control col-sm-8" id="exampleInput4" name="husband_flat_no" placeholder="Flat / Room No." value="{{$marriage->husband_flat_no}}" />
       ...
       <div class="row">
          <div class="col-md-6">
            <div class=" row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control col-sm-8" id="exampleInput4" name="husband_pincode" placeholder=" Pincode / Zipcode" value="{{$marriage->husband_pincode}}"/>
      ...
      <div class="card-header">
        ...
        <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " class="form-control" name="wife_name" placeholder="Please Enter Full Name of the Husband" value="{{$marriage->wife_name}}">
          ...
          <div class="row mb-3">
            <label for="inputEmail" class="col-sm-5 col-form-label">Religion</label>
            <div class="col-sm-7">
                <input type="text" style="max-width:200px; height: 35px; " class="form-control" id="inputEmail" name="wife_religion" placeholder="Religion" value="{{$marriage->wife_religion}}" >
          ...
          <div class="row mb-3">
            <label for="inputEmail" class="col-sm-5 col-form-label">Date of Birth</label>
            <div class="col-sm-7">
                <input type="date" style="max-width:200px; height: 35px; " class="form-control" name="wife_birthday" value="{{$marriage->wife_birthday}}" >
        ...
        <div class="row mt-4">
          <div class="col-md-6">
            <div class=" row mb-3">
              <label for="exampleInput4" class=" col-sm-3 form-label"> Nid No</label>
              <div class="col-sm-7">
                <input id="Nid No" type="number" class="form-control col-sm-9" id="exampleInput4" name="wife_nid" placeholder=" Nid No" value="{{$marriage->wife_nid}}" />
         ...
         <div class="row">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" id="exampleInput4" name="wife_city_name" placeholder="City Name" value="{{$marriage->wife_city_name}}" />
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
               <label for="exampleInput4" class="col-sm-6 form-label">Road / Street / Village Name</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" id="exampleInput4" name="wife_road_name" placeholder="Road / Street Name" value="{{$marriage->wife_road_name}}" />
          ...
          <div class="col-md-6">
            <div class=" row mb-3">
              <label for="exampleInput4" class=" col-sm-4 form-label">Flat / Room No.</label>
              <div class="col-sm-8">
                <input type="text" class="form-control col-sm-8" id="exampleInput4" name="wife_flat_no" placeholder="Flat / Room No."  value="{{$marriage->wife_flat_no}}"/>
       ...
       <div class="row">
          <div class="col-md-6">
            <div class=" row mb-3">
              <label for="exampleInput4" class=" col-sm-4 form-label"> Pincode / Zipcode</label>
              <div class="col-sm-8">
                <input type="text" class="form-control col-sm-8" id="exampleInput4" name="wife_pincode" placeholder=" Pincode / Zipcode" value="{{$marriage->wife_pincode}}" />
      ...
      <div class="card-body">
         <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " class="form-control" name="witness1_name" placeholder="Please Enter Full Name of the Witness" value="{{$marriage->witness1_name}}" >
        ...
        <div class="row mb-3">
            <label for="inputEmail" class="col-sm-5 col-form-label">Full Name of the Husband Witness</label>
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " name="witness2_name" class="form-control" placeholder="Please Enter Full Name of the Witness"  value="{{$marriage->witness2_name}}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " name="witness3_name" class="form-control" placeholder="Please Enter Full Name of the Witness"  value="{{$marriage->witness3_name}}" >
        ...
        <div class="row mb-3">
            <label for="inputEmail" class="col-sm-5 col-form-label">Full Name of the Wife Witness</label>
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " name="witness4_name" class="form-control" placeholder="Please Enter Full Name of the Witness"  value="{{$marriage->witness4_name}}" >
      ...
      <div class="row mt-2">
          <div class="col-md-6">
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input type="text" name="husband_contact_number" class="form-control col-sm-8" id="exampleInput4" placeholder=" Husband Contact Number"  value="{{$marriage->husband_contact_number}}" />
            ...
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input type="text" name="husband_email" class="form-control col-sm-8" id="exampleInput4" placeholder=" abc@email.com" value="{{$marriage->husband_email}}" />
       ...
       <div class="row mt-2">
          <div class="col-md-6">
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input type="text" name="wife_contact_number" class="form-control col-sm-8" id="exampleInput4" placeholder=" Wife Contact Number" value="{{$marriage->wife_contact_number}}" />
            ...
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input type="text" name="wife_email" class="form-control col-sm-8" id="exampleInput4" placeholder="abc@gmail.com" value="{{$marriage->wife_email}}" />
