        ...
        <div class="row">
          <div class="col-md-6">
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input type="number" class="form-control col-sm-9" id="exampleInput4" name="husband_nid" placeholder=" Nid No" value="{{$husband_nid}}" readonly  />
      ...
      <div class="card-header">
        ...
        <div class="card-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
                <input type="text" style="max-width:350px; height: 35px; " class="form-control" name="wife_name" placeholder="Please Enter Full Name of the Wife" value="{{old('wife_name')}}">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class=" row mb-3">
              <label for="exampleInput4" class=" col-sm-3 form-label"> Nid No</label>
              <div class="col-sm-7">
                <input id="Nid No" type="number" class="form-control col-sm-9" id="exampleInput4" name="wife_nid" placeholder=" Nid No" value="{{$wife_nid}}" readonly />
