      ...
      <div class="card-header">
        ...
        <div class="row mb-3">
         ...
         <div class="row ">
            ...
            <div class="col-sm-7">
                <input type="file" class="form-control" id="image" style="max-width:400px; height: 35px; " class="form-control" name="wife_signature" value="{{old('wife_nid')}}" >
            ...
            <div class=" row mb-3">
              ...
              <div class="col-sm-7">
                <input id="Nid No" type="number" class="form-control col-sm-9" id="exampleInput4" name="wife_nid" placeholder=" Nid No"  />
                 ...
                 @if ($errors->has('wife_nid_'))
                     <span class="text-danger error-text mt-1">{{ $errors->first('wife_nid') }}</span>
                @endif
              </div>
