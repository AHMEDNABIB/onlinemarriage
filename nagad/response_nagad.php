...
//header("Location: https://admission.nstu.edu.bd/student/payment/nagad/confirm/$json", TRUE, 301);
//header("Location: https://admission.nstu.edu.bd/student/payment/nagad/confirm/$json", TRUE, 301);
header("Location: http://localhost/nstu-admission-2021-22/public/student/payment/nagad/confirm/$json", TRUE, 301);
